export const About = () => {
  return (
    ...
    <button className="bg-[#374151] w-[105px] h-[28px] rounded-xl">About me</button>
    <div className="flex flex-row w-full h-[588px] justify-between ">
    <div className="w-[584px] h-[558px]"><img src="tom.png" alt="" /></div>
    <div className="w-[584px] h-[558px] gap-[24px] flex flex-col">
      <div className="text-white text-3xl flex  font-Semi bold ">Curious about me? Here you have it:</div>
