export const Hero = () => {
  return (
    <div className="w-full h-[556px] flex flex-row justify-between pt-20 pr-25 pl-24">
      <div className="font-normal  w-xl flex flex-col gap-12">
        <div className="text-white text-4xl flex  font-bold ">
          Hi, I’m Tom 👋
        </div>
        <p className="w-[600px] h-[96px] font-thin text-[16px] text-white">
        ...
        <div className="w-[600px] h-[36px] flex flex-row mt-[70px] gap-8 ">
